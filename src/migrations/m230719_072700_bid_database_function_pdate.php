...
/**
 * Class m230719_072700_bid_database_function_pdate
 */
class m230719_072700_bid_database_function_pdate extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->execute($sql__mydiv);
        $this->execute($sql__mymod);
        $this->execute($sql_gdmarray);
        $this->execute($sql_jdmarray);
        $this->execute($sql_jdmarray2);
        $this->execute($sql_pdate);
        $this->execute($sql_PMONTH);
        $this->execute($sql_pmonthname);
        $this->execute($sql_pyear);
        $this->execute($sql_pday);
        $this->execute($sql_gdmarray2);
        $this->execute($sql_gdate);
        $this->execute($sql_gdatestr);
